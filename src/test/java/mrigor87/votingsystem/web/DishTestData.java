...
/*    ('dish1',10.2,100000), *//*100003*//*
    ...
    public static final Dish DISH1=new Dish(100004,"Dish1",10);
    public static final Dish DISH2=new Dish(100005,"Dish1",10.1);
    public static final Dish DISH3=new Dish(100006,"Dish1",10.2);
    public static final Dish DISH4=new Dish(100007,"Dish1",10.3);
    public static final Dish DISH5=new Dish(100008,"Dish1",10.4);
    public static final Dish DISH6=new Dish(100009,"Dish1",10.5);

    public static final Collection<Dish> RESTAURANTS= Arrays.asList(DISH1,DISH2,DISH3,DISH4,DISH5,DISH6);
